...
model.load_state_dict(torch.load("best_model_ll.pth", weights_only=True))
model.eval()
...
plt.title("Confusion Matrix — best_model_ll")
plt.xlabel("Predicted"); plt.ylabel("Actual")
plt.tight_layout()
plt.savefig("confusion_matrix_ll.png", dpi=150)
plt.show()
...
plt.title("ROC Curve — best_model_ll")
plt.legend(loc="lower right")
plt.tight_layout()
plt.savefig("roc_curve_ll.png", dpi=150)
plt.show()

print("\n✓ confusion_matrix_v2.png saved")
print("✓ roc_curve_ll.png saved")